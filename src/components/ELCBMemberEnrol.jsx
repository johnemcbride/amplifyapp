...
function isUnder30(momentDate) {
    if (momentDate instanceof moment) {
        console.log(-1 * momentDate.diff(Date()) / (60 * 60 * 24 * 365.2425 * 1000))
...
export default function ELCBMemberEnrol({ user }) {
    ...
    return (
        <Formik
            validationSchema={
                yup.object().shape({
                    bands: yup.array().of(yup.string()).required("Required").test({
                                    ...
                                    <Table marginY={'10px'} size="small" aria-label="a dense table">
                                        ...
                                        <TableBody>
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">{user.forename} {user.surname}</TableCell>
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">{values.bands.join(', ')}</TableCell>
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">2023 Term 2 (2nd Jan - 3rd Mar)</TableCell>
